...
class BotAgent:
    ...
    def __init__(
        ...
        # Pair status is FAILED, LIVE, CLOSE, ERROR
        self.order_dict = {
            "market_1": market_1,
            "market_2": market_2,
    ...
    def check_order_status_by_id(self, order_id):
        ...
        Returns:
            str: The status of the order ("failed", "error", or "live").
        """
        ...
        # Guard: If order cancelled move into next pair
    ...
    def open_trades(self):
        ...
        # Ensure order is living before processing
